...
from cliport.models.network.resnet import ConvBlock, IdentityBlock
...
class ResNet45_10s(nn.Module):
    def __init__(self, input_shape, output_dim, device):
        ...
        self.conv2 = nn.Sequential(
            ...
            IdentityBlock(self.output_dim, [16, 16, self.output_dim], kernel_size=3, stride=1, final_relu=False, batchnorm=self.batchnorm)
        )
